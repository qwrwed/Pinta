...
- **`File > Open Recent` menu** - a submenu listing recently opened/saved files (most recent first, up to 10), with a "Clear List" entry. The list is persisted between sessions, and entries that can no longer be opened are dropped automatically.
